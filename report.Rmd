...
if (i == 3) {
  print(withMathJax(HTML(paste(
        ...
        round(model_3$ei.table[1,3],3), "and \\(\\LARGE \\beta_1 =\\)", round(model_3$ei.table[2,3]-model_3$ei.table[1,3],3),".", "<br/><br/>"))))
}
if (i == 4) {
  print(withMathJax(HTML(paste(
        params$dependent4,"=\\(\\LARGE\\beta_0 + \\beta_1\\)",params$independent, ".", "<br/><br/>Note that \\(\\LARGE\\beta_0 = \\)",
        round(model_4$ei.table[1,3],3), "and \\(\\LARGE \\beta_1 =\\)", round(model_4$ei.table[2,3]-model_4$ei.table[1,3],3),".", "<br/><br/>"))))
}

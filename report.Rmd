...
cat('First, we compare predictions from three different models for', params$candidate1, '\n')
cat('vote share given demographic and total vote data' , '\n')  
kable(model_1$ei.table)
cat('\\subsection{$Goodmans Ecological Regression$}')
cat('Next, we plot votes for', params$candidate1, 'by the proportion of the population', '\n')
...
cat("Finally, we calculate ecological inference predictions for", params$candidate1, "\n")
cat("'s vote share and plot them with credible intervals. If the intervals overlap,", "\n")
cat("we cannot conclude that there was racially polarized voting for", params$candidate1, ". \n")
